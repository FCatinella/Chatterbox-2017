...
FILE_DA_CONSEGNARE=Makefile chatty.c message.h ops.h stats.h config.h \
		   DATA/chatty.conf1 DATA/chatty.conf2 connections.h strutture.c \
		   strutture.h script.sh connections.c listener.c client.c Relazione.docx Relazione.pdf
# inserire il nome del tarball: es. NinoBixio
TARNAME=FabioCatinella
...
OBJECTS		= connections.o strutture.o listener.o client.o
